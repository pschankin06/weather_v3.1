...
window.addEventListener("load", (event)=>{
    const currentCity = (0, _storageJs.getCurrentCity)();
    if ((0, _storageJs.getCurrentCity)()) {
        getCityData(currentCity);
        getCityCoordinates(currentCity);
    }
    const citiesFromStorage = (0, _storageJs.getFavoriteCities)();
    if (citiesFromStorage) citiesFromStorage.forEach((city)=>(0, _viewJs.addToFavorites)(city));
});
function getCityName(event) {
    try {
        const cityName = (0, _viewJs.UI_ELEMENTS).INPUT.value || event.currentTarget.textContent;
...
async function getCityData(cityName) {
    try {
        ...
        (0, _viewJs.showCityData)(cityData);
        (0, _storageJs.storeCurrentCity)(cityData.name);
    } catch (error1) {
...
async function getCityForecast(latitude, longtitude) {
    try {
        ...
        const cityData = await serverResponse.json();
        console.log(cityData);
        (0, _viewJs.showForecast)(cityData);
    } catch (error1) {
...
function deleteCity(cityName) {
    ...
    console.log(favoriteCities);
    (0, _storageJs.storeFavoriteCities)(favoriteCities);
}
...
},{"./view.js":"2GA9o","./storage.js":"j1l1C","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2GA9o":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "UI_ELEMENTS", ()=>UI_ELEMENTS);
parcelHelpers.export(exports, "showCityData", ()=>showCityData);
...
function showCityData(cityData) {
    ...
    const weatherIconURL = `${(0, _mainJs.SERVER).IMAGE_URL}${weatherIcon}@2x.png`;
    const weather = `Weather: ${cityData.weather[0].main}`;
    const sunrise = `Sunrise: ${(0, _mainJs.convertTime)(cityData.sys.sunrise)}`;
    const sunset = `Sunset: ${(0, _mainJs.convertTime)(cityData.sys.sunset)}`;
...
function showForecast(cityData) {
    clearForecastTab();
...
function showItemData(forecastData, forecastItem) {
    const date = (0, _mainJs.convertDate)(forecastData.dt);
    const time = (0, _mainJs.convertTime)(forecastData.dt);
    const units = "\xb0";
    ...
    const conditionIconURL = `${(0, _mainJs.SERVER).IMAGE_URL}${conditionIcon}@2x.png`;
    const FORECAST_ITEM = {
...
function addToFavorites(cityName) {
    const isInList = (0, _mainJs.favoriteCities).has(cityName);
    if (!isInList) {
        (0, _mainJs.addToList)(cityName);
        (0, _storageJs.storeFavoriteCities)((0, _mainJs.favoriteCities));
...
function addListeners(cityName, cityLink, deleteButton, cityBox) {
    cityLink.addEventListener("click", (event)=>{
        clearInput();
        (0, _mainJs.getCityName)(event);
    });
    deleteButton.addEventListener("click", ()=>{
        (0, _mainJs.deleteCity)(cityName);
        deleteCityFromUI(cityBox);
    });
}

},{"./main.js":"bDbGG","./storage.js":"j1l1C","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"j1l1C":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "storeCurrentCity", ()=>storeCurrentCity);
parcelHelpers.export(exports, "getCurrentCity", ()=>getCurrentCity);
parcelHelpers.export(exports, "storeFavoriteCities", ()=>storeFavoriteCities);
parcelHelpers.export(exports, "getFavoriteCities", ()=>getFavoriteCities);
function storeCurrentCity(cityName) {
...
function storeFavoriteCities(citiesList) {
...
},{}]},["3Unyy","bDbGG"], "bDbGG", "parcelRequirec92a")
